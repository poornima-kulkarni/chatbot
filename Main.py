...
def get_gemini_response(prompt=None, files=None):
    ...
    if prompt and any(word in prompt.lower() for word in ["generate an image", "create an image", "draw", "image of", "visualize"]):
        ...
        if isinstance(image, Image.Image):
            st.image(image, caption="🎨 Generated by Replicate (Stable Diffusion)", use_column_width=True)
...
def generate_image_with_replicate(prompt):
    ...
    try:
        output_url = replicate.run(
            "stability-ai/stable-diffusion:db21e45e8c7e05436a7a2b4c7c4c0c876c0d4c8f10b453d437f13cd87b6f4ce7",
            input={"prompt": prompt}
        )
